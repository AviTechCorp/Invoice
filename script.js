document.addEventListener('DOMContentLoaded', () => {
    ...
    let isProUser = false; // To simulate user's subscription status
    let desiredProTheme = null; // To store the theme the user wanted
    ...
    const init = () => {
        ...
        themeSelect.addEventListener('change', (e) => {
            ...
            if (selectedOption.dataset.pro && !isProUser) {
                // User is trying to access a PRO feature
                e.preventDefault();
                themeSelect.value = document.body.dataset.theme || 'modern'; // Revert to current theme
                state.theme = themeSelect.value;
                desiredProTheme = e.target.value; // Remember which theme they wanted
                proModal.style.display = 'flex'; // Show the modal
            } else {
                // Allow theme change
        ...
        closeModalBtn.addEventListener('click', () => proModal.style.display = 'none');
        ...
        upgradeBtn.addEventListener('click', () => {
            ...
            alert('Upgrade successful! You now have access to all PRO features.');

            // Apply the desired theme
            if (desiredProTheme) {
                themeSelect.value = desiredProTheme;
                document.body.dataset.theme = desiredProTheme;
            }
        });
